...
<html lang="en">
  <head>
    ...
    <title>OilRig | Méguin Products</title>
    ...
    />
    <!-- Custom styles -->
    <link rel="stylesheet" href="./meguin_products.css" />
  </head>
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-link" href="../LIQUIMOLY/Liquimoly_main_page.php"
            >LIQUI MOLY</a
          >
          <a class="nav-link" href="./meguin_products.php">Méguin</a>
    ...
    <!-- javascript -->
    <script src="./meguin_products.js"></script>
