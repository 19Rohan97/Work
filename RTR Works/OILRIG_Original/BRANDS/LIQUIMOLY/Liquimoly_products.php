...
<html lang="en">
  <head>
    ...
    <title>OilRig | Liquimoly Products</title>
    ...
    />
    <!-- Custom styles -->
    <link rel="stylesheet" href="./Liquimoly_products.css" />
  </head>
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-link" href="Liquimoly_main_page.php">LIQUI MOLY</a>
          <a class="nav-link" href="../MEGUIN/meguin_products.php">Méguin</a>
          <a class="nav-link" href="../VESRAH/vesrah_products.php">Vesrah</a>
        </div>
        <div class="sign-in-1">
    ...
    <main class="my-menu">
      ...
      <section class="menu">
        ...
        <div class="title">
          ...
          <div class="underline border border-success bg-success"></div>
        </div>
        <!-- Filter buttons -->
        ...
        <div class="section-center">
          ...
          <img src="./menu-item.jpeg" alt="Item" class="photo" />
          <div class="item-info">
            <header>
              <h4>buttermilk pancakes</h4>
              <h4 class="price">$15</h4>
            </header>
            <p class="item-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Officia possimus distinctio, quis nisi voluptatibus sunt. Aliquam, totam. Aliquid, quisquam provident?</p>
            <p><button class="bag-btn" data-id="1">
    ...
    <!-- Cart Item -->
    <!-- <div class="cart-item">
            <img src="./image/item-1.jpeg" alt="Olaf Cake" />
            <div>
              <h4>Olaf Cake</h4>
              <h5>₹3000</h5>
    ...
    <!-- javascript -->
    <script src="./Liquimoly_products.js"></script>
...
<script src="https://checkout.razorpay.com/v1/checkout.js"></script>
    <script>
      $("body").on("click", ".bag-btn", function (e) {
