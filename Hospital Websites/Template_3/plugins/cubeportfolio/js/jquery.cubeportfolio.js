...
(function ($, window, document, undefined) {
  ...
  var popup = {
    ...
    init: function (cubeportfolio, type) {
      ...
      if (t.options.singlePageDeeplinking && type === "singlePage") {
        ...
        currentBlock = t.cubeportfolio.blocksAvailable
        ...
        if ($.inArray(href, tempHref) === -1) {
          ...
          if (/youtube/i.test(href)) {
            ...
            src =
              ...
              href.substring(href.lastIndexOf("v=") + 2) +
              "?autoplay=1";
    ...
    openSinglePage: function (blocks, currentBlock) {
      ...
      if (
        t.cubeportfolio.browser === "ie8" ||
        t.cubeportfolio.browser === "ie9"
      ) {
        setTimeout(function () {
          t.wrap.addClass("cbp-popup-singlePage-sticky");
        }, 1000);
    ...
    openSinglePageInline: function (blocks, currentBlock, fromOpen) {
      ...
      $.each(blocks.find(t.options.singlePageInlineDelegate), function (
        index,
        item
      ) {
        var href = item.getAttribute("href");
    ...
    _resizeSinglePageInline: function (removeLoadingMask) {
      ...
      t.cubeportfolio._resizeMainContainer(
        t.cubeportfolio.transition,
        customHeight
      );
    ...
    updateSelfHostedVideo: function (src, title, counter) {
      ...
      markup +=
        ...
        (title
          ...
          : "") +
        (t.options.lightboxShowCounter
          ? '<div class="cbp-popup-lightbox-counter">' + counter + "</div>"
          : "") +
        "</div>" +
        "</div>";
    ...
    resizeImage: function () {
      ...
      var height = $(window).height(),
        ...
        padding =
          ...
          parseInt(img.css("margin-bottom"), 10);
  ...
  var pluginObject = {
    ...
    _main: function (obj, options, callbackFunction) {
      ...
      if (
        t.options.displayType === "lazyLoading" ||
        t.options.displayType === "fadeIn"
      ) {
        t.$ul.css({
          opacity: 0,
        });
      ...
      if (
        t.options.displayType === "lazyLoading" ||
        t.options.displayType === "sequentially" ||
        t.options.displayType === "bottomToTop" ||
        t.options.displayType === "fadeInToTop"
      ) {
        t._load();
      } else {
        t._beforeDisplay();
    ...
    _pushTopCaptionDestroy: function () {
      ...
      if (t.browser === "ie8" || t.browser === "ie9") {
        $(".cbp-caption").off(
          "mouseenter" + eventNamespace + " mouseleave" + eventNamespace
        );
    ...
    _beforeDisplay: function () {
      ...
      if (t.options.animationType) {
        ...
        t.localColumnWidth =
          t.blocks.eq(0).outerWidth() + t.options.gapVertical;

        if (t.options.defaultFilter === "" || t.options.defaultFilter === "*") {
          t._display();
        } else {
          t.filter(
            t.options.defaultFilter,
            function () {
              t._display();
            },
            t
    ...
    _layout: function () {
      ...
      t.blocksAvailable.each(function (index, el) {
        ...
        if (
          t.singlePageInline &&
          index >= t.singlePageInline.matrice[0] &&
          index <= t.singlePageInline.matrice[1]
        ) {
    ...
    _responsiveLayout: function () {
      ...
      if (extra / t.localColumnWidth > 0.5) {
        t.localColumnWidth =
          t.localColumnWidth - (t.localColumnWidth - extra) / (t.cols + 1);
      } else {
    ...
    _wrapperFilter: function (
      ...
      if (t.transition === "css") {
        ...
        slideIn.each(function (index, el) {
          $(el)
            .find(".cbp-item-wrapper")
            .addClass("cbp-animation-" + name + "-in")
            .css("animation-delay", kkk / 20 + "s");
          kkk++;
        });
        ...
        slideOut.each(function (index, el) {
          if (kkk <= iii && fadeOut) {
            $(el)
              .find(".cbp-item-wrapper")
              .addClass("cbp-animation-" + name + "-fadeOut");
          } else {
            $(el)
              .find(".cbp-item-wrapper")
              .addClass("cbp-animation-" + name + "-out")
        ...
        if (toAnimate.length) {
          toAnimate.one(t.animationEnd, function () {
            ...
            if (t.browser === "ie10" || t.browser === "ie11") {
              setTimeout(function () {
                $(".cbp-item-wrapper").removeClass(
                  "cbp-animation-" + name + "-in"
                );
              }, 300);
            }
          });
    ...
    filter: function (filterName, callbackFunction, context) {
      ...
      if (t.singlePageInline && t.singlePageInline.isOpen) {
        t.singlePageInline.close("promise", {
          callback: function () {
            t["_" + t.options.animationType + "Filter"](
              on2offBlocks,
              off2onBlocks,
              filterName
            );
  ...
  $.fn.cubeportfolio = function (method) {
    ...
    return this.each(function () {
      ...
      if (pluginObject[method]) {
        return pluginObject[method].apply(
          this,
