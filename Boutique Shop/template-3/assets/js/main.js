  ...
  $(document).ready(function () {
    ...
    if ($testimonialOneCarousel.length > 0) {
      $testimonialOneCarousel.owlCarousel({
        ...
        nav: true,
        navText: [
          "<img src='assets/img/icon/arrow-left-black.svg' alt='Arrow Icon'>",
          "<img src='assets/img/icon/arrow-right-black.svg' alt='Arrow Icon'>",
        ],
        smartSpeed: 2000,
        responsive: {
          0: {
    ...
    $(".latest-blog-slider-for-images").slick({
      ...
      focusOnSelect: true,
      prevArrow:
        '<a class="slick-prev"><img src="assets/img/icon/arrow-left-white-2.svg" alt="Arrow Icon"></a>',
      nextArrow:
        '<a class="slick-next"><img src="assets/img/icon/arrow-right-white-2.svg" alt="Arrow Icon"></a>',
      rtl: true,
      // speed: 500,
      responsive: [
        {
    ...
    $(".latest-blog-slider-nav-content").slick({
      ...
      dots: false,
      prevArrow:
        '<a class="slick-prev"><img src="assets/img/icon/arrow-right-black.svg" alt="Arrow Icon"></a>',
      nextArrow:
        '<a class="slick-next"><img src="assets/img/icon/arrow-left-black.svg" alt="Arrow Icon"></a>',
      draggable: false,
      fade: true,
    ...
    $(".slider-two-active")
      ...
      .slick({
        ...
        prevArrow:
          '<a class="slick-prev"><img src="assets/img/icon/arrow-right-white.svg" alt="Arrow Icon"></a>',
        nextArrow:
          '<a class="slick-next"><img src="assets/img/icon/arrow-left-white.svg" alt="Arrow Icon"></a>',
        responsive: [
          {
            breakpoint: 1024,
            settings: {
    ...
    $(".slider-four-active")
      ...
      .slick({
        ...
        slidesToScroll: 1,
        prevArrow:
          '<a class="slick-prev"><img src="assets/img/icon/arrow-right-misti.svg" alt="Arrow Icon"></a>',
        nextArrow:
          '<a class="slick-next"><img src="assets/img/icon/arrow-left-misti.svg" alt="Arrow Icon"></a>',
        responsive: [
          {
            breakpoint: 1024,
            settings: {
