        ...
        if (null != d) {
          ...
          function c(r) {
            n && clearInterval(n),
              ...
              (r = e(".rVideo__player .rvideo_player_btn")).hasClass(
                "rvideo_play"
              )
                ? (d.play(),
                  r.addClass("rvideo_pause").removeClass("rvideo_play"))
                : r.hasClass("rvideo_pause") &&
                  (clearInterval(n),
                  d.pause(),
                  r.addClass("rvideo_play").removeClass("rvideo_pause"));
          }
          r.autoplay && (d.play(), c(e(".rvideo_player_btn, .rVideo__Player"))),
            ...
            e(
              ...
              r.preventDefault(),
                c(e(this)),
                s.find(".rVideo__player__thumb").removeClass("active");
            }),
